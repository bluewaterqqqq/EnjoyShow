...
public class MsgCenterFragment extends android.support.v4.app.Fragment {
    ...
    private ArrayList<ESNotification> mData = new ArrayList<>();
    ...
    private void initViews(View view) {
        ...
        mAdapter = new NotificationAdapter(view.getContext(), mData);
    ...
    private void pullData() {
        ...
        JsonObjectRequest request = new JsonObjectRequest(url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                ArrayList<ESNotification> data = parseResponse2Data(response);
    ...
    private ArrayList<ESNotification> parseResponse2Data(JSONObject response) {
        ArrayList<ESNotification> list = null;
        if (response != null) {
            int state = -1;
            try {
                ...
                if (state == 0) {
                    ...
                    JSONArray data = result.optJSONArray("notifyList");
                    if (data != null) {
                        list = new ArrayList<>();
                        list.addAll(ESNotification.convertByJSONArray(data));
                    }
                }
    ...
    protected String getRequestAction() {
        return ActionConstants.ACTION_LOAD_NOTIFY;
    }
